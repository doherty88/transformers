...
class Sst3Processor(DataProcessor):
    """Processor for the SST-3 data set (GFN Sentiment version)."""
...
class GfnClassProcessor(DataProcessor):
    """Processor for the GFN NLP Class data set (GFN Sentiment version)."""
